...
"""
1. full_name(first, last)        → returns "First Last"
2. add(*numbers)                 → returns sum of any numbers
3. greet(name, greeting="Hello") → returns "Hello, Name!"
4. describe(**info)              → prints each key: value
5. find_oldest(students)         → returns oldest student using lambda
"""
